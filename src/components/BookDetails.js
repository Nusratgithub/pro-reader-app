  ...
  return (
    <div className='px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-2xl md:px-24 lg:px-8 lg:py-20'>
      <div className='flex flex-col max-w-screen-lg overflow-hidden bg-white border rounded shadow-lg lg:flex-row sm:mx-auto'>
        ...
        <div className='flex flex-col justify-center p-8 bg-white lg:p-10 lg:pl-10 lg:w-1/2'>
          <div>
            <p className='inline-block px-3 py-1 mb-4 text-sm font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-teal-400'>
              Brand new
            </p>
          </div>
          ...
          <p className='mb-5 text-gray-900 font-semibold'>
